...
public class EquipListTransform : MonoBehaviour
{
    ...
    public List<EquipFunction> buttonOnThisList;
    ...
    private void Awake()
    {
        ...
        radiaus = 2.5f;
        buttonOnThisList = new List<EquipFunction>();
        angularSpeed = 90f; //90度转

    }

    public void ShowButtons(List<EquipFunction> buttons)
    {
        //按钮间隔
